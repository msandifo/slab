...
fig.dir="/Users/msandifo/Dropbox/msandifo/documents/programming/r/packages/slab/examples/guatemala/figures"
...
mex <-assemble_slab(slab.name="mex", extend.lims = c(3, -2, 0, -3.5),  simplify=T)
...
p2=get_poly(long=-89., lat=10.5, angle=35, width=1.6, length=4 )
l2 =
  get_line(long=-89., lat=10.5, angle=35,   length=5,  n=1, psp=T)
...
p2a<-split_owin(bird.plates.psp[p2], p2, rev=T)
